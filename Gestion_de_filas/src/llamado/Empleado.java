...
public class Empleado {
	...
	public String llamarCliente() throws ConnectException {
		...
		this.emisor_server.enviar(gestorSeguridad.protegerDNI("Cliente/"+this.numeroDePuesto), this.puertoEmisor);
	...
	public String pedirEstado() throws ConnectException {
		this.emisor_server.enviar(gestorSeguridad.protegerDNI("Estado/"+this.numeroDePuesto), this.puertoEmisor);
	...
	public void enviarCliente_Server(String msj) throws ConnectException {
		if (msj != null) {
			...
			this.emisor_server.enviar(gestorSeguridad.protegerDNI(msj + "/" + this.numeroDePuesto), this.puertoEmisor);
		}
